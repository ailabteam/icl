...
class QKDSatelliteEnv(gym.Env):
    ...
    def __init__(self, num_satellites=5, num_ground_stations=3, duration_hours=24, time_step_minutes=1):
        ...
        gs_locations = {
            'Hanoi': (21.02, 105.85, 20),      # Vietnam
            'Paris': (48.85, 2.35, 35),        # France
            'NewYork': (40.71, -74.00, 10),    # USA (East)
            'Tokyo': (35.68, 139.69, 40),      # Japan
            'Sydney': (-33.86, 151.20, 58),    # Australia
            'SaoPaulo': (-23.55, -46.63, 760), # Brazil
            'Johannesburg': (-26.20, 28.04, 1753), # South Africa
            'LosAngeles': (34.05, -118.24, 71) # USA (West)
        }
